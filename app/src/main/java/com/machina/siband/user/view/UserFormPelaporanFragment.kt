...
class UserFormPelaporanFragment : Fragment() {
      ...
      override fun afterTextChanged(s: Editable?) {
        ...
        AdminFirestoreRepo.getListRuanganRef(s.toString())
          ...
          .addOnSuccessListener { snapshot ->
            ...
            val ruanganAdapter =
              ArrayAdapter(requireContext(), R.layout.item_list_dropdown, arrayRuangan)
            (binding.fragmentPelaporanRuangan.editText as? AutoCompleteTextView)?.setAdapter(
              ruanganAdapter
            )
  ...
  private fun onSubmit() {
    ...
    val nama = viewModel.getCurrentName()
